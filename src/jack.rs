...
//!
//! `research-gaps.md` §2.6 asks for "Knop–Sahi, the Lassalle recurrences, or the
//! Laplace–Beltrami eigenoperator, rather than Gram–Schmidt". All three named
//! routes are dealt with in `docs/spec-jack.md`; the eigenoperator one wins, and
//! the reason is arithmetic rather than combinatorics — it enumerates nothing at
//! all, and its denominator at every step is a *single* atom of [`AFrac`].
//!
...
//! dead end is recorded in `docs/spec-jack.md` §3.7.
//!
//! ## Normalizations
//!
//! ```text
...
//! like a full expansion and needs over 360 s at n = 12 (`docs/spec-jack.md`
//! §2.2).
//!
//! ## Sources
//!
...
/// dominance order.
///
/// Dispatches to [`jack_p_lb`]. `spec-jack.md` §7.1 leaves the whole-degree
/// engine choice open between the two routes; [`jack_table`] answers it with a
...
/// `docs/spec-jack.md` §2 are measured in, and the one Sage has no entry point
/// for.
...
/// (`docs/spec-jack.md` §2.2), which is the first size the conjecture is
/// interesting at.
///
