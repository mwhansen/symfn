...
MANAGES_ITS_OWN = {
    ...
    "bench_sf_candidates.py": "sets it in the LLT control arm's environment and refuses without it",    "check_qt_kostka.py": "carries the guard inline, predating sage_guard.py",
