"""Pre-implementation swell measurement for docs/record/jack.md.
...
separate necessary-condition pass (docs/record/macdonald-operators.md).
...
Rust exists — the move docs/record/macdonald-operators.md records.
