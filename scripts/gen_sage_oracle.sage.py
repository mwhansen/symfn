...
_sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_7 = Integer(7); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_4 = Integer(4); _sage_const_8 = Integer(8)# Generate the Sage oracle fixture consumed by tests/sage_oracle.rs.
#
...
MAX_JACK = _sage_const_7      # degree for the Jack sweep
...
for n in range(_sage_const_1 , MAX_JACK + _sage_const_1 ):
    for lam in Partitions(n):
